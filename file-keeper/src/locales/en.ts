export default {
  ...
  clipboard: {
    ...
    groups: {
      ...
      deleteConfirm: 'Records in this group will move to Ungrouped. Their content will not be deleted.',
      namePlaceholder: 'Group name (1–40 characters)',
      renameLabel: 'Rename group {name}',
      empty: 'No custom groups yet'
    },
    actions: {
      selectAll: 'Select All',
      ...
      moveSelectedToGroup: 'Move Selected',
      pin: 'Pin',
      unpin: 'Unpin',
      pinned: 'Pinned',
      moveToGroup: 'Move to Group',
      contextMenu: 'Clipboard record actions',
      copy: 'Copy',
      copyFile: 'Copy File',
      openLink: 'Open Link',
      openFile: 'Open File',
    ...
    notices: {
      ...
      groupActionFailed: 'Group action failed. Check the name and try again.',
      mutationFailed: 'Operation failed. The previous state has been restored.',
      pinned: 'Pinned',
      unpinned: 'Unpinned',
      moved: 'Moved to the target group',
      pinnedSelected: 'Selected records pinned',
      unpinnedSelected: 'Selected records unpinned',
      movedSelected: 'Selected records moved'
    },
    toolbar: {
