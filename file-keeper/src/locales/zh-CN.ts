export default {
  ...
  clipboard: {
    ...
    groups: {
      ...
      cancel: '取消',
      confirmDelete: '确认删除',
      deleteConfirm: '删除分组后，组内记录会移到“未分组”，不会删除内容。',
      namePlaceholder: '输入分组名称（1—40 字符）',
      renameLabel: '重命名分组 {name}',
      empty: '还没有自定义分组'
    },
    actions: {
      selectAll: '全选',
      ...
      pinSelected: '批量置顶',
      unpinSelected: '取消置顶',
      moveSelectedToGroup: '移动选中项',
      pin: '置顶',
      unpin: '取消置顶',
      pinned: '已置顶',
      moveToGroup: '移动到分组',
      contextMenu: '剪贴板记录操作菜单',
      copy: '复制',
      copyFile: '复制文件',
      openLink: '打开链接',
      openFile: '打开文件',
    ...
    notices: {
      ...
      groupActionFailed: '分组操作失败，请检查名称后重试',
      mutationFailed: '操作失败，界面已恢复到操作前状态',
      pinned: '已置顶',
      unpinned: '已取消置顶',
      moved: '已移动到目标分组',
      pinnedSelected: '已置顶选中记录',
      unpinnedSelected: '已取消选中记录置顶',
      movedSelected: '已移动选中记录'
    },
    toolbar: {
