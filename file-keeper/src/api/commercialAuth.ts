import { registerClientDevice as registerDevice } from './device'
import type { ClientDevice, DeviceIdentity } from './device'

export { getOrCreateDeviceIdentity } from './device'
export type { ClientDevice, DeviceIdentity } from './device'
...
export async function registerClientDevice(
  ...
  return await registerDevice(baseUrl, accessToken, identity)
}
