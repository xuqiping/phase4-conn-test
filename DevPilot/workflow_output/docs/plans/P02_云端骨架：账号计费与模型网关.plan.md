...
### Step 1 · NestJS 骨架 + Postgres/Redis 接线（FR-041 地基）
...
### Step 2 · 云端建表 V1/V3 + 本地开发种子（FR-041/050 地基）
...
### Step 5 · 模型网关 chat：SSE 转发 + 权威计量（FR-041/003 支撑，AC-053 主链）
...
### Step 6 · 搜索网关：降级链 + 计次计费（FR-050，AC-053/054）
