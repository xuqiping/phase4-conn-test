...
- [ ] **Step 1：Flyway V56~V59 + 实体/Mapper + AclService**
...
- [ ] **Step 8：前端 api/types/路由/Sidebar**
  ...
  - **文件**：`api/assets.ts`、`types/asset.ts`、`router/index.ts`、`components/Sidebar.vue`
