...
public final class AuditLabelDictionary {
    ...
    private static final Map<String, Map<String, String>> ACTION_LABEL = Map.ofEntries(
            ...
            Map.entry("memory", Map.ofEntries(
                    ...
                    // B6（8x-3 P3）：Memory 五 Controller
                    Map.entry("tag_create", "新建记忆标签"),
                    Map.entry("tag_update", "修改记忆标签"),
                    Map.entry("tag_reclassify", "重分类记忆标签"),
                    Map.entry("entry_review", "复核记忆条目"),
                    Map.entry("entry_delete", "删除记忆条目"),
                    Map.entry("gen_config_set", "设置记忆生成配置"),
